...
insert into sys_config values(10, '用户登录-是否允许多端登录', 'sys.login.multiDevice', 'true', 'Y', 'admin', sysdate(), '', null, '是否允许同一账号多端同时在线（true允许，false不允许）');
...
create table sys_notice (
  ...
  is_top            char            default '0' not null        comment '是否置顶（0否 1是）',
